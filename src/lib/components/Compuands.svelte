<script lang="ts">
	...
	const compoundsArabic = [
		...
		{
			formula: '02 // SCENT',
			name: 'شراكات قائمة على الثقة',
			desc: 'نعتز بثقة مئات العملاء المحليين ونخبة الموردين العالميين، ملتزمين ببناء علاقات عمل وثيقة ومستدامة مع كافة شركائنا.',
			target: 90,
			suppliers: 25
		},
		{
			formula: '03 // AGENCY',
			name: 'نتائج مؤكدة',
			desc: 'ريادة في المبيعات والتسليم تضمن نجاح عمليات الاستيراد، وسلاسة العمليات اللوجستية، وانتشاراً واسعاً في الأسواق.',
			target: 80,
			suppliers: 10
		}
	];
